export const projectsData = [
    {
        ...
        info: "The Conway's game of Life the cellular automaton algorithm rendered in React. The state is managed with Redux using reducers to handle the state of each cell.",
        image: require('../../images/conway.png'),
        tags: "React, Redux.",
        page_url: "https://conways-game-of-life-mu.vercel.app/",
